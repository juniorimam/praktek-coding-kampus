...
import uas.view.transaksi.FormEditPustaka;
import uas.view.transaksi.FormTambahPustaka;
...
public class FormPustaka extends javax.swing.JFrame {
    ...
    */
    ...
    private void HapusPustaka(String id) {
         //pertanyaan
         int ya = JOptionPane.showConfirmDialog(null,"Apakah Anda yakin Menghapus transaksi dengan id "+id+"?","Konfirmasi",JOptionPane.YES_NO_OPTION);
         
         if (ya == 0 ) {
             try {
                 Connection k = Koneksi.getKoneksi();
                 String query ="DELETE FROM pustaka WHERE id=" + id;
    ...
    private void initComponents() {
        ...
        BtnTambah.setDisabledIcon(null);
        ...
        BtnHapus.setBounds(280, 450, 110, 30);
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        FormTambahPustaka tambah = new FormTambahPustaka();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        // TODO add your handling code here:
        int baris = TblPustaka.getSelectedRow();
        String id = (String) TblPustaka.getValueAt(baris, 0);
        
        FormEditPustaka edit = new FormEditPustaka (id);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormPustaka().setVisible(true);
            }
        });
    }
