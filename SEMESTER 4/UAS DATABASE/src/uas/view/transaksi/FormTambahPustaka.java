...
public class FormTambahPustaka extends javax.swing.JFrame {
    int id;

    public FormTambahPustaka() {
        initComponents();
        Tampil();
    }
    ...
    private void Tampil(){
        ...
        String query_pustaka = "select id from pustaka order by id Desc Limit 1";
        
        try {
              Statement stmt = k.createStatement();
              ResultSet rs = stmt.executeQuery(query_pustaka);
              
              while (rs.next()){
                  int id_pustaka_baru = Integer.parseInt(rs.getString("id"))+1;
                  String id_pustaka_baru_s = Integer.toString(id_pustaka_baru);
                  LId.setText(id_pustaka_baru_s);
                  }
                  rs.close();
  ...
  private void TambahPustaka(int id, String judul, String pengarang, String penerbit, String tahun, String isbn, int jumlah, String jenisbuku, String lokasirak){
      
        String query = "Insert into pustaka(id,judul,pengarang,penerbit,tahun,isbn,jumlah,jenis_buku,lokasi_rak)"
                       +"Values(?,?,?,?,?,?,?,?,?)";
        Connection k =Koneksi.getKoneksi();
        ...
        try {
            ...
            patmt.setInt(1, id);
            patmt.setString(2, judul);
            patmt.setString(3, pengarang);
            patmt.setString(4, penerbit);
            patmt.setString(5, tahun);
            patmt.setString(6, isbn);
            patmt.setInt(7, jumlah);
            patmt.setString(8, jenisbuku);
            patmt.setString(9, lokasirak);
            patmt.executeUpdate();
            this.dispose();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TAMBAH PUSTAKA");
        jPanel1.add(jLabel1);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        TambahPustaka(id,judul,pengarang,penerbit,tahun,isbn,jumlah,jenisbuku,lokasirak);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTambahPustaka.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormTambahPustaka().setVisible(true);
            }
        });
    }
