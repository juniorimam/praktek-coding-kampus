...
public class FormIDAnggota extends javax.swing.JFrame {


    public FormIDAnggota() {
        initComponents();
        TampilTblIDAnggota();
    }
    
    private void TampilTblIDAnggota() {
    ...
    private void initComponents() {
        ...
        TblIDAnggota = new javax.swing.JTable();
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(-10, 130, 970, 50);
        ...
        BtnKembali.setBounds(808, 440, 122, 30);
        ...
        TblIDAnggota.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        Tabel.setViewportView(TblIDAnggota);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormIDAnggota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormIDAnggota().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable TblIDAnggota;
