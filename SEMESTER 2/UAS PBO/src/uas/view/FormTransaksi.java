...
import uas.view.transaksi.FormEditTransaksi;
import uas.view.transaksi.FormTambahTransaksi;
...
public class FormTransaksi extends javax.swing.JFrame {
    ...
    */
    private void TampilTblTransaksi() {
        ...
        dtm.addColumn("Pemesan");
        dtm.addColumn("Petugas");
        dtm.addColumn("Harga Tiket");
        ...
        // buat query
        String query = "SELECT * FROM transaksi ORDER BY idtransaksi ASC ";
    ...
    private void HapusTransaksi(String idtransaksi) {
         //pertanyaan
         int ya = JOptionPane.showConfirmDialog(null,"Apakah Anda yakin Menghapus transaksi dengan id "+idtransaksi+"?","Konfirmasi",JOptionPane.YES_NO_OPTION);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Transaksi Tiket Kereta Api Stasiun Solo Balapan");
        jPanel1.add(jLabel2);
    ...
    private void BtnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTambahActionPerformed
        ...
        FormTambahTransaksi ftt = new FormTambahTransaksi();
        ftt.setVisible(true);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        ...
        String idtransaksi = (String) TblTransaksi.getValueAt(baris, 0);
        
        FormEditTransaksi fet = new FormEditTransaksi (idtransaksi);
        fet.setVisible(true);
