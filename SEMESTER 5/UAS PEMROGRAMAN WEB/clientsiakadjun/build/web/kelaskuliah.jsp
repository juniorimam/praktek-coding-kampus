<html>
<head>
    <title>SIAKAD 2020 - Kelas Kuliah</title>
...
<body>
  ...
  <div class="isi">
      ...
      <br>
            <h1>Daftar Kelas Kuliah</h1>
            <hr><br>
            <div class="search">
                <a class="edit" href="tambah/tambah-kelas.jsp">Tambah Kelas Kuliah</a>
            </div>
            Berikut Kelas Kuliah yang ada di STMIK Sinar Nusantara Surakarta.
            <br>
                ...
                <tbody>
                    <tr>
                        ...
                        try {
                            ...
                            java.util.List<java.lang.Object> result = port.tampilKelas();
                            out.println(result);
                        } catch (Exception ex) {
